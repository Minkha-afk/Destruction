...
export default function MessageBubble({ sender, text, timestamp, avatar, isCurrentUser }: BubbleMessage) {
    ...
    return (
        <motion.div
            ...
            className={cn("group flex items-end gap-3 px-1", alignment)}
        >
            {!isCurrentUser && (
            ...
            <div className="max-w-[82%] space-y-1 sm:max-w-[72%]">
                <div
                    className={cn(
                ...
                <div
                    className={cn(
                        "relative px-4 py-2.5 text-sm leading-relaxed shadow-sm backdrop-blur-lg",
                        isCurrentUser
